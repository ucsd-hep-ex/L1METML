...
def main(args):
    ...
    for ifile in list_files_Test:
        XList.append(testGenerator._DataGenerator__get_features_labels(ifile, 0, testGenerator.max_entry)[0])
        Yr_test.append(testGenerator._DataGenerator__get_features_labels(ifile, 0, testGenerator.max_entry)[1])
    for X in XList:
