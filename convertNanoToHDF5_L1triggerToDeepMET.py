...
def find_root_files(input_path, pattern='*.root'):
    ...
    if input_path.is_file():
        ...
        if not root_files:
            raise ValueError(f"No ROOT files found in {input_path} with pattern {pattern}")
...
def convert_single_file(input_file, output_file, maxevents=-1, is_data=False):
    ...
    varList = [
        ...
        'L1PuppiCands_dxyErr', 'HGCal3DCl_hoe','HGCal3DCl_showerlength','HGCal3DCl_coreshowerlength'
    ]
    ...
    d_encoding = {
        ...
        'L1PuppiCands_pdgId': {-999.0: 0, -211.0: 1, -130.0: 2, -22.0: 3, -13.0: 4, -11.0: 5,
                               11.0: 5, 13.0: 4, 22.0: 3, 130.0: 2, 211.0: 1}
    }
    ...
    coreshowerlength = to_np_array(tree['HGCal3DCl_coreshowerlength'], maxN=maxNPuppi, pad=-999)
